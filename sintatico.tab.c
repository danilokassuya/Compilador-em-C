...
{
       0,   110,   110,   127,   129,   134,   135,   139,   167,   195,
     199,   298,   299,   303,   310,   314,   324,   355,   393,   397,
     401,   402,   406,   417,   421,   478,   485,   494,   503,   507,
     516,   528,   531,   532,   536,   540,   547,   557,   564,   572,
     580,   587,   596,   599,   607,   615,   621,   639,   645,   648,
     654,   655,   663,   664,   672,   683,   694,   708,   709,   721,
     722,   735,   745,   749,   756,   760,   767,   771,   778,   782,
     788,   792,   803,   818,   819,   828,   839,   850,   861,   875,
     876,   887,   901,   902,   913,   927,   928,   939,   950,   964,
     965,   975,   976,   987,   998,  1009,  1020,  1031,  1042,  1053,
    1067,  1070,  1077,  1084,  1091,  1102,  1103,  1107,  1112,  1120,
    1131,  1134,  1145,  1156,  1162,  1174,  1186
};
#endif
...
#line 2783 "sintatico.tab.c"
    break;

  case 91:
#line 975 "sintatico.y"
                          {(yyval.no) = (yyvsp[0].no);}
#line 2789 "sintatico.tab.c"
    break;
...
#line 2996 "sintatico.tab.c"
  ...
  case 108:
#line 1112 "sintatico.y"
                        {
            node *no = (yyvsp[0].no);
            no->prox = NULL;
            (yyval.no)  = no;
    }
#line 3006 "sintatico.tab.c"
    break;

  case 109:
#line 1120 "sintatico.y"
           { 
...
#line 3104 "sintatico.tab.c"
    break;

  case 116:
#line 1186 "sintatico.y"
                  {
            lc *lico = (yyvsp[0].lc);
            node *no = (node*)malloc(sizeof(node));
            no->exp = 0;
